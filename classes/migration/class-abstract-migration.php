 ...
 */
if ( ! class_exists( '\AWEF\Migration\Abstract_Migration' ) ) {
	...
	class Abstract_Migration {
		...
		public static function migrate() {
			...
			if ( version_compare( static::get_stored_version(), AWEF_VERSION, '<' ) ) {

				$stored_version_as_number  = static::normalize_version( static::get_stored_version() );
				$target_version_as_number  = static::normalize_version( AWEF_VERSION );
