...
if ( ! class_exists( '\AWEF\Helpers\Review_Plugin' ) ) {
	...
	class Review_Plugin {
		...
		public const REVIEW_OPTION_KEY = 'awef_review_plugin_option';

		public const LINK_ID = 'awef_review_plugin_link_id';
		...
		public static function script() {
			...
			<script>
				jQuery(document).on('click', '.awef-review-notice .notice-dismiss', function () {
					jQuery.ajax({
						url: ajaxurl,
						type: 'post',
						data: {
							pointer: jQuery(this).closest('.awef-review-notice').attr('id'),
