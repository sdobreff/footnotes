 ...
 */
if ( ! class_exists( '\AWEF\Settings\Settings_Builder' ) ) {
	/**
	...
	class Settings_Builder {
		...
		private static function upload() {
			...
			<div class="image-preview-wrapper">
				<input <?php echo self::$item_id_attr; ?> <?php echo self::$name_attr; ?> class="awef-img-path" type="text"
					value="<?php echo esc_attr( self::$current_value ); ?>" <?php echo self::$placeholder_attr; ?>>
				<input id="<?php echo 'upload_' . self::$item_id . '_button'; ?>" type="button" class="awef-upload-img button"
		...
		private static function upload_font() {
			...
			<div class="image-preview-wrapper">
				<input <?php echo self::$item_id_attr; ?> <?php echo self::$name_attr; ?> class="awef-font-path" type="text"
					value="<?php echo esc_attr( self::$current_value ); ?>" <?php echo self::$placeholder_attr; ?>>
				<input id="<?php echo 'upload_' . self::$item_id . '_button'; ?>" type="button" class="awef-upload-font button"
					value="<?php echo $upload_button; ?>">
		...
		private static function checkbox() {
			...
			$toggle_data  = ! empty( self::$settings['toggle'] ) ? 'data-awef-toggle="' . self::$settings['toggle'] . '"' : '';
			$toggle_class = ! empty( self::$settings['toggle'] ) ? 'awef-toggle-option' : '';

			?>
				<input <?php echo self::$item_id_attr; ?> <?php echo self::$name_attr; ?>
					class="awef-js-switch <?php echo $toggle_class; ?>" <?php echo $toggle_data; ?> type="checkbox" value="true"
							<?php echo $checked; ?>>
							<?php
		}
		...
		private static function color() {
			...
			<div class="awef-custom-color-picker">
		...
		private static function posts() {
			?>
			<div class="awef-custom-posts-selector">
		...
		private static function post() {
			?>
			<div class="awef-custom-post-selector">
		...
		private static function fonts() {
			?>
			<input <?php echo self::$name_attr; ?> <?php echo self::$item_id_attr; ?> class="awef-select-font" type="text" value="<?php echo esc_attr( self::$current_value ); ?>">
			<?php
		}
		...
		private static function notice_message() {
			...
			self::$custom_class .= ' awef-message-hint';

			if ( 'error' === self::$option_type ) {
				self::$custom_class .= ' awef-message-error';
			} elseif ( 'success' === self::$option_type ) {
				self::$custom_class .= ' awef-message-success';
			}
		...
		private static function section_head() {
			...
			<h3 <?php echo self::$item_id_attr; ?> class="awef-section-title <?php echo self::$custom_class; ?>">
			<?php
		...
		private static function option_head() {
			...
			if ( ! empty( self::$settings['pre_text'] ) ) {
				?>
				<div class="awef-option-pre-label"><?php echo self::$settings['pre_text']; ?></div>
				<div class="clear"></div>
				<?php
			}
			...
			if ( ! empty( self::$settings['name'] ) ) {
				?>
				<span class="awef-label"><?php echo self::$settings['name']; ?></span>
				<?php
			}
		}
		...
		private static function visual() {
			?>
			<ul id="awef_<?php echo self::$item_id; ?>" class="awef-options">
		...
		private static function gallery() {
			...
			class="awef-upload-image awef-primary-buttonton button button-primary button-large"
			value="<?php esc_html_e( 'Add Image', 'awesome-footnotes' ); ?>">

			<ul id="<?php echo esc_attr( self::$item_id ); ?>-gallery-items" class="awef-gallery-items">
				<?php
		...
		private static function background() {
			...
			<input id="<?php echo esc_attr( self::$item_id ); ?>-img" class="awef-img-paawef-igaro-background-path"
			...
			<div class="awef-background-options">
		...
		private static function typography() {
			...
			<div class="awef-custom-select typography-custom-select">
