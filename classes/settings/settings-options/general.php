...
use AWEF\Controllers\Footnotes_Formatter;
	...
	<ol class="footnotes awepost_0">
		<li id="footnote_0_1" class="footnote">
			...
			<?php echo ( ( $before_position ) ? $back_link : '' ); ?> <?php esc_html_e( 'First footnote', 'awesome-footnotes' ); ?> <?php echo ( ( ! $before_position ) ? $back_link : '' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
		</li>
		<li id="footnote_1_1" class="footnote">
			...
			<?php echo ( ( $before_position ) ? $back_link : '' ); ?> <?php esc_html_e( 'Second footnote', 'awesome-footnotes' ); ?> <?php echo ( ( ! $before_position ) ? $back_link : '' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
		</li>
		<li id="footnote_2_1" class="footnote">
			...
			<?php echo ( ( $before_position ) ? $back_link : '' ); ?> <?php esc_html_e( 'Third footnote', 'awesome-footnotes' ); ?> <?php echo ( ( ! $before_position ) ? $back_link : '' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
		</li>
	</ol>
<?php
	...
	Settings::build_option(
		array(
			'name' => esc_html__( 'Show backlink in the beginning of the footnote', 'awesome-footnotes' ),
